...
public class SarasawiyaGenerator extends Generator{
	int sYear;
	int eYear;
	int sMonth;
	int eMonth;
	...
	public SarasawiyaGenerator(int sYear, int eYear, int sMonth, int eMonth,
		...
		if (dt.getDayOfWeek() >= DateTimeConstants.THURSDAY) {
	        dt = dt.plusWeeks(1);
	    }
	...
	public String baseGenerator() {
		String url = "http://sarasaviya.lk/" + year + "/"
